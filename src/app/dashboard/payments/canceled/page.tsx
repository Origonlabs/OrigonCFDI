...
import { EyeRegular, FilterRegular, ArrowDownloadRegular, ChevronDownRegular, ChevronDoubleLeftRegular, ChevronDoubleRightRegular, ChevronLeftRegular, ChevronRightRegular, DocumentRegular, MoreHorizontalRegular, ErrorCircleRegular } from "@/icons/fluent";
...
export default function CanceledPaymentsPage() {
  ...
  return (
    <div className="flex flex-col flex-1 gap-4">
      <h1 className="text-lg font-bold font-headline">Pagos Cancelados</h1>
      <Card className="flex flex-col flex-1">
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/30 hover:bg-muted/30">
                ...
                <TableHead>Folio que Sustituye</TableHead>
              ...
              {loading ? (
                ...
                <TableRow>
                  <TableCell colSpan={16} className="text-center h-24">
                    No hay pagos cancelados para mostrar
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
        ...
        <div className="p-2 border-t bg-muted/30 flex justify-between items-center text-xs">
          ...
          <div className="text-muted-foreground">
              {payments.length > 0 ? `Mostrando ${payments.length} pagos cancelados` : 'No hay pagos para mostrar'}
          </div>
        </div>
      </Card>
    </div>
