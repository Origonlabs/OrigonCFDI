...
const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      t.resizeObserver?.disconnect();
      cancelAnimationFrame(t.raf!);
      t.renderer.domElement.removeEventListener('pointerdown', onPointerDown as EventListener);
      t.renderer.domElement.removeEventListener('pointermove', onPointerMove as EventListener);
      t.quad?.geometry.dispose();
      t.material.dispose();
      t.composer?.dispose();
      t.renderer.dispose();
